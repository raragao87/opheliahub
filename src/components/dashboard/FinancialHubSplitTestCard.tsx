...
const FinancialHubSplitTestCard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-semibold text-gray-900 mb-3">Financial Hub Split View</h3>
      <p className="text-gray-600 leading-relaxed mb-4">
        Test the new split-view interface with accounts on the left and transactions on the right for better workflow efficiency.
      </p>
